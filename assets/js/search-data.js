  ...
  },
  {
    ...
    handler: () => {
      window.location.href = "/team/#shixiaoshuang";
          ...
          description: "",
          section: "News",},{id: "news-论文-attention-guided-knowledge-distillation-based-deep-multiple-instance-learning-for-gigapixel-whole-slide-image-analysis-被-pattern-recognition-jcr-q1-发表",
          title: '论文 Attention-guided knowledge distillation based deep multiple instance learning for gigapixel whole slide...',
          description: "",
          section: "News",},{id: "news-论文-coin-uncertainty-guarding-selective-question-answering-for-foundation-models-with-provable-risk-guarantees-被-aaai-2026-ccf-a-录用",
          title: '论文 COIN: Uncertainty-Guarding Selective Question Answering for Foundation Models with Provable Risk Guarantees...',
          description: "",
          section: "News",},{id: "news-论文-lec-linear-expectation-constraints-for-selection-conditioned-risk-control-in-selective-prediction-and-routing-systems-被-icml-2026-ccf-a-录用",
          title: '论文 LEC: Linear Expectation Constraints for Selection-Conditioned Risk Control in Selective Prediction and...',
          description: "",
